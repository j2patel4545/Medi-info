    ...
    return (
        <div id="home" className="flex bg-[#F9F9F9] flex-col h-screen w-screen">
            ...
            <div id="up" className="flex flex-col  items-center justify-start pt-24 font-recolate h-[70%] w-full bg-[#28574E]">
                ...
                <div id="search" className=' flex mt-5 w- full p-2 justify-center items-center gap-4'>
                    <input type="search" placeholder='search your Application' className='p-2 text-white w-96 rounded-3xl backdrop-blur-sm bg-white/30 outline-none  px-6' />
                        <button className=' p-2 px-6 rounded-full bg-[#F9F9F9] text-[#28574E]'>Explore</button>
                </div>
            </div>
            ...
            <div
                ...
                className="flex flex-col items-center justify-center h-[30%] w-full bg-[#F9F9F9]" >
                    <div className=' justify-center rounded-3xl items-center shadow-md backdrop-blur-sm flex h-[60vh] align-top absolute w-[60vw] mb-[31vh] bg-zinc-50/20'>
